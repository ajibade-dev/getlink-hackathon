...
const Privacy = () => {
  return (
    ...
    <div className='flex flex-col md:flex-row bg-deep-blue w-full max-w-[1600px] py-20 lg:px-20 px-10'>
      ...
      className='font-bold font-montserrat text-xl md:text-3xl lg:text-4xl  text-white'>Privacy Policy and</motion.h1>
          <motion.h1
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          ...
          className='font-bold font-montserrat text-xl md:text-3xl lg:text-4xl text-light-purple'>Terms</motion.h1>
          ...
          className='text-slate-400 font-montserrat font-normal md:text-base text-xs leading-7 md:w-1/2 w-full mt-4'>
          ...
          className='text-white font-montserrat font-normal md:text-base leading-7 md:w-3/4 w-full mt-4 text-xs'>Below are our privacy & policy, which outline a lot of goodies. It's our aim to always take care of our participant</motion.p>
        ...
        {/* the box underneath */}
          ...
          className='flex-flex-col mt-[68px] w-full md:text-start h-auto md:px-16 md:py-14  py-8 bg-transparent border-2 rounded-md border-light-purple font-montserrat'>
